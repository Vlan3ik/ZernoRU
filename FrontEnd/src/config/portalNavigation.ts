...
export const mainNavigation: PortalNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'news-cis', label: 'Новости СНГ', path: '/news?section=cis' },
...
export const marketRailWidgets = {
  exchanges: [
    'Биржа Санкт-Петербург: пшеница 3 класс — 16 840 ₽/т (+1,3%)',
    'МосБиржа: кукуруза — 15 120 ₽/т (+0,7%)',
    'Новороссийск FOB: ячмень — 13 950 ₽/т (+0,9%)',
  ],
  indices: [
  ...
  quickReviews: [
    ...
    { label: 'Риски по экспортным каналам СНГ', path: '/countries/kazakhstan' },
  ],
};
