...
export function LotDetailPage() {
  ...
  const gallery = lotImageMap[lot.id] ?? ['/images/thematic/image_01.jpg'];
        ...
        <Col xs={24} xl={8}>
          <Card className="sticky-actions-card" title="Действия по лоту">
            <Space direction="vertical" style={{ width: '100%' }}>
              ...
              <Button icon={<MessageOutlined />} block>Запросить условия</Button>
              <Button icon={<PhoneOutlined />} block>Связаться с продавцом</Button>
              <Button block>Рассчитать доставку</Button>
              <Button block>Добавить в избранное</Button>
            </Space>
          </Card>
