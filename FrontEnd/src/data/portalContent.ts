...
export const newsFeed: NewsItem[] = [
  ...
  {
    id: 'n-3',
    title: 'Поставки кукурузы в Казахстан и Беларусь выросли на фоне дефицита внутреннего предложения',
    lead: 'Экспортеры из России и Казахстана усилили отгрузки на фоне стабильного спроса со стороны переработчиков СНГ.',
    section: 'Новости СНГ',
    country: 'Казахстан',
    culture: 'Кукуруза',
    region: 'ЕАЭС',
