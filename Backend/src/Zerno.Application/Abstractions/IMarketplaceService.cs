...
public interface IMarketplaceService
{
    ...
    Task<IReadOnlyList<AuctionSummaryDto>> GetAuctionSummariesAsync(CancellationToken cancellationToken);
    Task<AuctionSummaryDto?> GetAuctionAsync(Guid lotId, CancellationToken cancellationToken);
    Task<IReadOnlyList<AuctionBidDto>> GetAuctionBidsAsync(Guid lotId, CancellationToken cancellationToken);
    Task<AuctionSummaryDto> PlaceAuctionBidAsync(Guid userId, Guid lotId, PlaceAuctionBidRequestDto request, CancellationToken cancellationToken);
